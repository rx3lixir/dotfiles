return {
	...
	opts = function(_, opts)
		...
		local colors = {
			...
			overlay = "#000000",
			scrim = "#000000",
			-- Mode-specific colors (using Nord palette)
			mode_normal = "#81a1c1", -- nord9 (blue)
			mode_insert = "#a3be8c", -- nord14 (green)
			mode_visual = "#b48ead", -- nord15 (purple)
			mode_replace = "#bf616a", -- nord11 (red)
			mode_command = "#ebcb8b", -- nord13 (yellow)
			mode_terminal = "#8fbcbb", -- nord7 (teal)
		}
		-- ============================================================================
		-- HELPER FUNCTIONS
		-- ============================================================================
